class GeoLocalizacion {
    ...
    initDynamicMap(){
        this.currentParent = document.getElementById("dynamicMap");
        let oviedo = {lat: 43.3672702, lng: -5.8502461};
        let mapaOviedo = new google.maps.Map(document.getElementById('dynamicMap'),{zoom: 8,center:oviedo});
        let marcador = new google.maps.Marker({position:oviedo,map:mapaOviedo});
    }
